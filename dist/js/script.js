...
if (hrs < 11) greet = 'Good Morning 🌄';
else if (hrs >= 11 && hrs <= 14) greet = 'Good Morning 🌞';
else if (hrs >= 15 && hrs <= 17) greet = 'Good Afternoon 🌇';
else if (hrs >= 18 && hrs <= 24) greet = 'Good Evening 🌙';
document.getElementById('greetings').innerHTML = '<b>' + greet + '</b>';

// Typed
new Typed('#typed', {
  strings: ['Vision and Mission', 'Facilities', 'Collection', 'History of Batik'],
  typeSpeed: 100,
  delaySpeed: 200,
  loop: true,
});
